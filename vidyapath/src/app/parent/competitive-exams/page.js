...
export default function ParentCompetitiveExamsPage() {
    ...
    <div className={styles.listingPage}>
      <div className={styles.pageHeader}>
        <div className={styles.pageHeaderLeft}>
          ...
          <p>Track important entrance exams like NEET, JEE, CUET, and NTA updates for your child.</p>
        </div>
