    ...
    <div className={styles.listingPage}>
      ...
      <div className={styles.filterBar}>
        ...
        <select className={styles.filterSelect}>
          ...
          <option>School</option><option>District</option><option>State</option><option>National</option><option>International</option>
        </select>
      ...
      {loading ? (
        ...
        <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-secondary)' }}>No competitions found in this category.</div>
      ) : (
