    ...
    <div className={styles.container}>
      ...
      <div className={styles.headerSection}>
        ...
        <p className={styles.subtitle}>
          Access official board results, roll-number verification portals, and mark sheets directly inside your dashboard.
        </p>
      </div>
        ...
        <div className={styles.modalOverlay} onClick={handleClosePortal}>
          <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.modalBanner}>
              ...
              ). Enter your Roll Number or Credentials below to retrieve your scores. If the portal is blank, click <strong>Open in New Tab</strong>.
            </div>
