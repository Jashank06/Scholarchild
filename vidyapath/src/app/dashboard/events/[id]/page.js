...
export default function StudentEventDetailPage() {
  ...
  if (!event) return <div style={{ textAlign: 'center', padding: '60px' }}><div style={{ fontSize: '64px', marginBottom: '20px' }}>🎪</div><h2>Event not found</h2><button onClick={() => router.push('/dashboard/events')} style={{ padding: '12px 24px', background: '#F5576C', color: 'white', border: 'none', borderRadius: '100px', cursor: 'pointer', fontWeight: '700' }}>← Back</button></div>;

  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
      <button onClick={() => router.push('/dashboard/events')} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: '#F3F4F6', border: 'none', borderRadius: '100px', cursor: 'pointer', color: '#374151', fontWeight: '600', fontSize: '14px', marginBottom: '24px' }}>← Back to Events</button>
